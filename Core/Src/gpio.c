...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(E_CS_GPIO_Port, E_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(E_RES_GPIO_Port, E_RES_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, E_DC_Pin|O_BLK_Pin|O_RST_Pin|O_CS_Pin
                          |O_DC_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : E_RES_Pin */
  GPIO_InitStruct.Pin = E_RES_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(E_RES_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : E_DC_Pin O_BLK_Pin O_RST_Pin O_CS_Pin
                           O_DC_Pin */
  GPIO_InitStruct.Pin = E_DC_Pin|O_BLK_Pin|O_RST_Pin|O_CS_Pin
                          |O_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
