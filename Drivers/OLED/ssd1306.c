...
void ssd1306_Rotate180(void) {
    ssd1306_WriteCommand(0xA1);   // Segment remap (горизонтальное зеркало)
    ssd1306_WriteCommand(0xC8);   // COM remap (вертикальное зеркало)
}

void ssd1306_Rotate0(void) {
    ssd1306_WriteCommand(0xA0);   // Normal segment
    ssd1306_WriteCommand(0xC0);   // Normal COM
}
